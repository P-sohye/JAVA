...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*선언은 stack 영억에 배열의 주소를 보관할 수 있는 공간을 만드는 것이다.*/
        int[] iarr;
        char carr[];

        /*선언한 래퍼런스 변수에 배열을 할당하여 대입할 수 있다.
        * new 연산자는 heap 영역에 공간을 할당하고 발생한 주소값을 반환하는 연산자이다.
        * 발생한 주소를 래퍼런스 변수(참조형 변수)에 저장하고 이것을 참조하여 사용하기 때문에 참조 자료형 이라고 한다.
        * */
...
//        iarr = new int[]; // 크기를 지정해 주지 않아서 에러 발생
        ...
        String[] sarr = {"red", "yellow", "blue", "green"};
...
//        System.out.println("삭제 후 darr의 길이: " + darr.length);  // NullPointerException
